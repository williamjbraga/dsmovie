...
create table tb_score (value float8, move_id int8 not null, user_id int8 not null, primary key (move_id, user_id));
create table tb_user (id int8 generated by default as identity, email varchar(255), primary key (id));
alter table if exists tb_score add constraint FK60r4vrex21w1klw9jvq25uuel foreign key (move_id) references tb_movie;
